...
import 'package:studenthub/widgets/notification_alert/info_toast_icon.dart';
import 'package:studenthub/widgets/notification_alert/resources/arrays.dart';
import 'package:studenthub/widgets/notification_alert/resources/colors.dart';
        ...
        pageBuilder: (context, _, __) => GestureDetector(
          ...
          child: SafeArea(
            ...
            child: AlertDialog(
              ...
              elevation: 0,
              insetPadding: const EdgeInsets.symmetric(horizontal: 0, vertical: 8.0),
              content: Column(
...
class _InfoToastState extends State<InfoToast> with TickerProviderStateMixin {
  ...
  Widget _renderLeftLayoutToast(BuildContext context) {
    return Column(
      mainAxisAlignment: widget.toastPosition == Position.top ? MainAxisAlignment.start : MainAxisAlignment.end,
      children: [
        SlideTransition(
