...
class CompanyBloc extends Bloc<CompanyEvent, CompanyState> {
  CompanyBloc()
    ...
    on<SetEventActionToStudent>(_onHireStudentProprosal);
    on<SetActiveProposal>(_onSetActiveProposal);
  }
...
//   }
  ...
  Future<void> _onHireStudentProprosal(SetEventActionToStudent event, Emitter<CompanyState> emit) async {
    try {
  ...
  Future<void> _onSetActiveProposal(SetActiveProposal event, Emitter<CompanyState> emit) async {
    try {
      ResponseAPI result = await _companyService.setActiveProposal(event);
