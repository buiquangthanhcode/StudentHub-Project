...
class StudentState extends Equatable {
  ...
  final List<Project> workingProject;
  ...
  StudentState update({
    ...
    return StudentState(
      ...
      workingProject: workingProject ?? this.workingProject,
    );
  }
  ...
  Map<String, dynamic> toMap() {
    ...
    result.addAll({'workingProject': workingProject.map((x) => x.toMap()).toList()});
    return result;
  }
  ...
  factory StudentState.fromMap(Map<String, dynamic> map) {
    return StudentState(
      ...
      workingProject: List<Project>.from(map['workingProject']?.map((x) => Project.fromMap(x))),
    );
  }
  ...
  @override
  List<Object> get props => [student, isChange, submitProjectProposals, activeProjectProposals, workingProject];
}
