...
class SocketService {
  ...
  static final IO.Socket _socketNotification = IO.io("https://api.studenthub.dev",
      OptionBuilder().enableForceNew().setTransports(['websocket']).disableAutoConnect().build());
  ...
  static void receiveNotification(String userId, dynamic Function(dynamic) callback) {
